...
#define _WIN32_WINDOWS 0x0410	// Specifies that the minimum required platform is Windows 98.
	...
	#pragma comment(lib,"./EasyXWithGDIPlus/easyxw.lib")
#elif !defined(UNICODE) && (_MSC_VER > 1200)
	#pragma comment(lib,"./EasyXWithGDIPlus/easyx.lib")
#elif defined(UNICODE)
	#pragma comment(lib,"./EasyXWithGDIPlus/easyxw6.lib")
#elif !defined(UNICODE)
	#pragma comment(lib,"./EasyXWithGDIPlus/easyx6.lib")
#endif
